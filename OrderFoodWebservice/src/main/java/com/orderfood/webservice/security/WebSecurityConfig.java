...
import com.orderfood.webservice.jwt.JwtAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/user/**").hasAnyRole("MEMBER","ADMIN")
                .antMatchers("/login", "/notification", "/register", "/uploads/**").permitAll()
